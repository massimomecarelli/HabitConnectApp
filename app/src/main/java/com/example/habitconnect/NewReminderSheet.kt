...
class NewReminderSheet : BottomSheetDialogFragment()
{
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        viewModel = ViewModelProvider(this, ViewModelProvider.AndroidViewModelFactory.getInstance(application))[FragmentRemindersViewModel::class.java]
    ...
    {
        var newReminder = Reminder(0,"Reminder",DateFormat.getDateInstance().toString(),DateFormat.getTimeInstance().toString())
